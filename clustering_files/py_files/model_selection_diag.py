...
file_names = ['diag_2', 'diag_2_pca', 'diag_3', 'diag_3_pca', 'diag_4', 'diag_4_pca', 'diag_5', 'diag_5_pca', 'diag_6', 'diag_6_pca', 'diag_7', 'diag_7_pca', 'diag_8', 'diag_8_pca', 'diag_9', 'diag_9_pca', 'diag_10', 'diag_10_pca', 'diag_11', 'diag_11_pca', 'diag_12', 'diag_12_pca']
mavg = []
...
df.to_csv(path_to_csv+"/model_selection_diag.csv", index=False) 
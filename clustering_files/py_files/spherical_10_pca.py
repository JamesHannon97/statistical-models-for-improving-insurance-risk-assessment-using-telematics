...
# PCA = True
# GMM = 'spherical', 10 components, Continuous+Discrete+PCA - Continuous[PCA], Scaling:True
import os
import sys
...
import joblib
# Set parameters
file_name = 'spherical_10_pca'  #### Edit
scaling = True
n_components = 10
...
mod = gmmglm(df=df, 
             ...
             output_to_file = True,
             file_path = path+'/clustering_files/clustering_results/files/'+file_name+'.txt', 
...
# Pickle files
file = open(path+'/clustering_files/clustering_results/txt/'+file_name, 'wb') 

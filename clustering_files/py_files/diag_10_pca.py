...
# PCA = True
# GMM = 'diag', 10 components, Continuous+Discrete+PCA - Continuous[PCA], Scaling:True
import os
import sys
...
import joblib
os.makedirs(path+'/clustering_files/clustering_results/', exist_ok=True)
# Set parameters
file_name = 'diag_10_pca'  #### Edit
scaling = True
n_components = 10
